                ...
                <div className="space-y-4">
                  {triageReports.map((report) => {
                    try {
                      ...
                      // Skip malformed reports rather than crashing
                      return (
                        <div key={report.session_id} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                          <p className="text-sm text-gray-400">Report data could not be rendered.</p>
                          <Link
                            href={`/history/${report.session_id}`}
                            className="text-xs text-teal-600 hover:text-teal-700 mt-2 inline-block"
                          >
