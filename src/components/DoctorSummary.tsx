...
export default function DoctorSummary({
  ...
  return (
    <div className="doctor-summary w-full bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden animate-slide-up">
      ...
      <div className="hidden print:block px-5 pt-4 pb-2 border-b border-gray-300">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Sehat AI Triage Report</h2>
            <p className="text-xs text-gray-500">AI-Assisted Medical Triage Summary</p>
          </div>
      ...
      {/* Header */}
      <div className="bg-gray-50 px-5 py-3 border-b border-gray-200 flex items-center gap-2 print:hidden">
        <svg
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-gray-300 font-mono print:hidden">{refId}</span>
        </div>
